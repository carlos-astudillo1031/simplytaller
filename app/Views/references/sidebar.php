...
<div id="app">
    ...
    <div class="sidebar-menu">
        <ul class="menu">   
            <?php if (session()->get('id_tipo_usuario') == 1): ?>

                 <li data-segment="dashboard" class="sidebar-item">
                    <a href="<?=base_url('/public/dashboard')?>" class='sidebar-link'>
                        <i class="fas fa-boxes"></i>
                        <span>Dashboard</span>
                    </a>                    
                 </li>

                 <li data-segment="configuracion"
                    ...
                    <a href="#" class='sidebar-link'>
                     ...
                     <ul class="submenu ">
                        ...
                        <li class="submenu-item  ">
                            <a href="<?=base_url('/public/config/clientes')?>" class="submenu-link">Clientes</a>                        
                        </li>
                        
                        <li class="submenu-item  ">
                            <a href="<?=base_url('/public/config/usuarios')?>" class="submenu-link">Usuarios</a>
            ...
            <li
                ...
                <ul class="submenu ">
                    ...
                    <li class="submenu-item  ">
                        <a href="account-security.html" class="submenu-link"><?=session()->get('nombre_usuario')?></a>
                        
                    </li>

                     <li class="submenu-item  ">
                        <a href="<?= base_url('public/logout'); ?>" class="submenu-link">Cerrar Sesión</a>
